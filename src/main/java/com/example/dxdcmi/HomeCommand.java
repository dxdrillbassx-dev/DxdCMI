...
public class HomeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        player.teleport((plugin.getPluginConfig().getLocation("homes." + player.getName() + "." + homeName)));
        player.sendMessage(plugin.getMessage("teleport_home").replace("{home}", homeName));
        return true;
    }
}
